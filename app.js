...
const FOOD_EMOJIS = {
  ...
  // きのこ
  'しいたけ': '🍄', 'しめじ': '🍄', 'エリンギ': '🍄', 'えのき': '🍄',
  'まいたけ': '🍄', 'なめこ': '🍄', 'きくらげ': '🍄', 'マッシュルーム': '🍄',
  'エノキ': '🍄', 'ぶなしめじ': '🍄', 'マイタケ': '🍄', 'しいたけ（乾）': '🍄',
  '干ししいたけ': '🍄', 'ひらたけ': '🍄',
  // 肉・魚
  '豚肉': '🥓', '鶏肉': '🍗', '牛肉': '🥩', '豚ひき肉': '🥩', '鶏ひき肉': '🍗',
  '豚バラ肉': '🥓', '豚こま切れ肉': '🥩', '豚ロース肉': '🥩',
...
const BUILT_IN_RECIPES = [
  ...
  },
  {
    ...
    requiredIngredients: [
      ...
      { name: 'ごぼう', quantity: 0.5, unit: '本', optional: false },
      { name: '里芋', quantity: 2, unit: '個', optional: true },
      { name: 'こんにゃく', quantity: 0.5, unit: '枚', optional: true },
      { name: 'ネギ', quantity: 0.5, unit: '本', optional: false },
      { name: 'しょうが', quantity: 1, unit: '片', optional: true },
      { name: '味噌', quantity: 3, unit: '大さじ', optional: false },
      { name: 'ごま油', quantity: 1, unit: '大さじ', optional: false },
    ],
    steps: [
      '大根・にんじんはいちょう切り、ごぼうはささがき、里芋・こんにゃくは一口大にする',
      '鍋にごま油を熱し、豚バラ肉とすりおろしたしょうがを炒める',
      '肉の色が変わったら野菜を加えてさっと炒め、かさの1/3ほどの水を注いでふたをし、中火で5分蒸し煮にする',
      '具がひたひたになるまで水と顆粒だしを足し、沸騰したら弱火で10分煮る',
  ...
  },
  {
    ...
    requiredIngredients: [
      ...
      { name: '醤油', quantity: 1, unit: '大さじ', optional: false },
      { name: '鶏ガラスープ', quantity: 200, unit: 'ml', optional: false },
      { name: '花椒', quantity: 1, unit: '適量', optional: false },
      { name: '片栗粉', quantity: 1, unit: '大さじ', optional: false },
      { name: 'ごま油', quantity: 1, unit: '大さじ', optional: false },
    ],
    steps: [
      '木綿豆腐は2cm角に切り、下ゆでして水気をきる',
      'にんにく・しょうが・ねぎはみじん切りにする',
      '油で豚ひき肉を香ばしくなるまでしっかり炒め、豆板醤・甜麺醤・にんにく・しょうがを加えて炒める',
      '鶏ガラスープと醤油を加え、豆腐を入れて数分煮る',
      '水溶き片栗粉でとろみをつける',
      '仕上げにねぎと花椒（粉山椒）をたっぷり振り、ごま油を回しかけて完成！',
    ],
    isCustom: false,
  },
  {
  ...
  },
  {
    ...
    requiredIngredients: [
      ...
      { name: 'ピーマン', quantity: 2, unit: '個', optional: true },
      { name: 'ネギ', quantity: 0.5, unit: '本', optional: false },
      { name: 'にんにく', quantity: 1, unit: 'かけ', optional: false },
      { name: 'しょうが', quantity: 1, unit: 'かけ', optional: false },
      { name: '甜麺醤', quantity: 1.5, unit: '大さじ', optional: false },
      { name: '豆板醤', quantity: 1, unit: '小さじ', optional: false },
      { name: '醤油', quantity: 2, unit: '小さじ', optional: false },
      { name: '料理酒', quantity: 1, unit: '大さじ', optional: false },
      { name: '砂糖', quantity: 0.5, unit: '小さじ', optional: false },
      { name: 'ごま油', quantity: 1, unit: '大さじ', optional: false },
    ],
    steps: [
      '豚バラ肉（かたまり）を水からゆで、アクを取りながら中火で10〜15分煮て、冷めたら5mmほどの薄切りにする',
      'キャベツはざく切り、ピーマンは乱切り、ねぎは斜め薄切り、にんにく・しょうがはみじん切りにする',
      'フライパンにごま油を熱し、にんにく・しょうがを炒めて香りを出し、豚肉を加えて炒める',
      '肉を端に寄せ、豆板醤・甜麺醤を加えて油となじませ香りを立たせる',
      '醤油・酒・砂糖を加え、キャベツ・ピーマン・ねぎを入れて強火で手早く炒める',
      'キャベツにシャキッと感を残して全体に味がからんだら完成！',
    ],
    isCustom: false,
  },
  // --- エスニック（タイ料理） ---
  {
    ...
    requiredIngredients: [
      ...
      { name: 'パプリカ', quantity: 0.5, unit: '個', optional: false },
    ...
    steps: [
      '玉ねぎは粗みじん切り、ピーマンとパプリカは細切り、にんにくはみじん切り、唐辛子は小口切り、バジルはざく切りにする。',
      'フライパンに油を熱し、にんにくと唐辛子を中火で炒めて香りを出す。',
      '鶏ひき肉を加え、ほぐしすぎず粗めの食感を残して色が変わるまで炒める。',
      '玉ねぎ・ピーマン・パプリカを加えて炒め、ナンプラー・オイスターソース・醤油・砂糖で味付けし、3分ほど炒める。',
      '最後にバジルを加えてさっと混ぜ、味をみて塩で調える。',
  ...
  // --- 揚げ物 ---
  {
    ...
    requiredIngredients: [
      ...
      { name: '卵', quantity: 1, unit: '個', optional: false },
      { name: '小麦粉', quantity: 3, unit: '大さじ', optional: false },
      { name: '片栗粉', quantity: 3, unit: '大さじ', optional: false },
    ],
    steps: [
      '鶏もも肉は大きめの一口大に切る',
      '醤油・料理酒・すりおろしたにんにく・しょうがを合わせ、鶏肉を漬けて冷蔵庫で1時間以上漬け込む',
      '溶き卵を加えてよく揉み込む',
      '小麦粉と片栗粉を同量ずつ合わせてまぶす',
      '160〜170℃の油で3〜4分揚げ、一度取り出して数分休ませる',
      '180℃に温度を上げてカリッと二度揚げし、油を切って完成！',
    ],
    isCustom: false,
  },
  {
    id: 'r079', name: 'とんかつ', category: '洋食', emoji: '🍖',
    description: 'サクサク衣のボリューム満点な揚げ物。キャベツを添えて。',
    requiredIngredients: [
      { name: '豚ロース肉', quantity: 2, unit: '枚', optional: false },
      { name: '塩', quantity: 1, unit: '少々', optional: false },
      { name: 'こしょう', quantity: 1, unit: '少々', optional: false },
      { name: '薄力粉', quantity: 3, unit: '大さじ', optional: false },
      { name: '卵', quantity: 1, unit: '個', optional: false },
      { name: 'パン粉', quantity: 1, unit: 'カップ', optional: false },
      { name: 'キャベツ', quantity: 3, unit: '枚', optional: true },
    ],
    steps: [
      '豚ロース肉は筋切りをして塩・こしょうを振る',
      '薄力粉→溶き卵→パン粉の順に衣をつける',
      '170℃の油で片面3分ずつ揚げる',
      'こんがりきつね色になったら取り出し油を切る',
      '食べやすく切り、千切りキャベツを添えて完成！',
    ],
    isCustom: false,
  },
  {
    id: 'r080', name: 'エビフライ', category: '洋食', emoji: '🍤',
    description: 'プリプリのえびをサクッと揚げた、ごちそう感のある一品。',
    requiredIngredients: [
      { name: 'えび', quantity: 8, unit: '尾', optional: false },
      { name: '塩', quantity: 1, unit: '少々', optional: false },
      { name: '薄力粉', quantity: 3, unit: '大さじ', optional: false },
    ...
    steps: [
      'えびは殻をむいて背わたを取り、腹側に切り込みを入れてまっすぐ伸ばす',
      '塩を振り、薄力粉→溶き卵→パン粉の順に衣をつける',
      '175℃の油で2〜3分カラッと揚げる',
      '油を切って器に盛り、お好みでタルタルソースを添えて完成！',
    ],
    isCustom: false,
  },
  {
    id: 'r081', name: 'コロッケ', category: '洋食', emoji: '🥔',
    description: 'ほくほくじゃがいもの定番コロッケ。冷めても美味しい。',
    requiredIngredients: [
      { name: 'じゃがいも', quantity: 4, unit: '個', optional: false },
      { name: '玉ねぎ', quantity: 0.5, unit: '個', optional: false },
    ...
    steps: [
      'じゃがいもを茹でて熱いうちにつぶす',
      'フライパンで玉ねぎのみじん切りと豚ひき肉を炒め、塩・こしょうで味付けする',
      'つぶしたじゃがいもと炒めた具を混ぜ、小判形に成形する',
      '薄力粉→溶き卵→パン粉の順に衣をつける',
      '180℃の油できつね色になるまで揚げる',
      '油を切って器に盛れば完成！',
    ],
  ...
  {
    id: 'r082', name: '野菜の天ぷら', category: '和食', emoji: '🍤',
    description: 'サクサク軽い衣の天ぷら。旬の野菜で彩りよく。',
    requiredIngredients: [
      { name: 'さつまいも', quantity: 0.5, unit: '本', optional: false },
      { name: 'なす', quantity: 1, unit: '本', optional: true },
      { name: 'かぼちゃ', quantity: 100, unit: 'g', optional: true },
      { name: 'ピーマン', quantity: 2, unit: '個', optional: true },
      { name: '薄力粉', quantity: 1, unit: 'カップ', optional: false },
      { name: '卵', quantity: 1, unit: '個', optional: false },
    ],
    steps: [
      '野菜を食べやすい大きさに切る',
      '冷水150mlに卵を溶き、薄力粉をさっくり混ぜて衣を作る',
      '野菜に衣をつけ、170℃の油で揚げる',
      'からりと揚がったら油を切る',
      '天つゆや塩を添えて完成！',
    ],
  ...
  },
  {
    ...
    requiredIngredients: [
      ...
      { name: 'しょうが', quantity: 1, unit: '片', optional: false },
      { name: 'にんにく', quantity: 2, unit: '片', optional: false },
      { name: 'ネギ', quantity: 1, unit: '本', optional: false },
      { name: '昆布', quantity: 5, unit: 'cm', optional: true },
      { name: '料理酒', quantity: 100, unit: 'ml', optional: false },
      { name: 'みりん', quantity: 50, unit: 'ml', optional: false },
      { name: '塩', quantity: 1, unit: '小さじ', optional: false },
      { name: 'こしょう', quantity: 1, unit: '少々', optional: false },
    ],
    steps: [
      '豚バラ肉（かたまり）に塩・こしょうをすり込む',
      'フライパンで表面全体に焼き色をつける',
      '圧力鍋に肉・しょうが・つぶしたにんにく・ねぎの青い部分・昆布を入れる',
      '水200ml・料理酒・みりん・塩を加えて全体を混ぜる',
      '加圧して火を通し、圧力が自然に抜けるまで1時間ほど置く',
      '食べやすく切り分けて完成！煮汁はチャーハンや味玉に活用できます',
    ],
    isCustom: false,
  },
  {
    ...
    requiredIngredients: [
      ...
      { name: '醤油', quantity: 1, unit: '小さじ', optional: false },
      { name: '料理酒', quantity: 1, unit: '大さじ', optional: false },
      { name: '鶏ガラスープ', quantity: 100, unit: 'ml', optional: false },
      { name: '片栗粉', quantity: 1, unit: '大さじ', optional: false },
      { name: 'ごま油', quantity: 1, unit: '大さじ', optional: false },
    ],
    steps: [
      'えびは殻をむいて背わたを取り、塩・酒・片栗粉（分量外）で揉んで洗い、水気をふく',
      'ねぎ・にんにく・しょうがはみじん切りにする',
      'フライパンに油を熱し、えびをさっと炒めて一度取り出す',
      'にんにく・しょうが・豆板醤を炒めて香りを出し、ケチャップを加えて炒める',
      '鶏ガラスープ・砂糖・醤油・酒を加え、えびを戻し入れて絡める',
      '水溶き片栗粉でとろみをつけ、ねぎとごま油を加えて完成！',
    ],
    isCustom: false,
  },
];
...
const QUICK_INGREDIENTS = [
  ...
  { name: 'まいたけ',     category: 'きのこ' },
  { name: 'エリンギ',     category: 'きのこ' },
  { name: 'マッシュルーム', category: 'きのこ' },
  { name: 'なめこ',       category: 'きのこ' },
  { name: 'きくらげ',     category: 'きのこ' },
  // 肉・魚
  ...
  // 大豆製品
  { name: '豆腐',         category: '大豆製品' },
  { name: '納豆',         category: '大豆製品' },
  { name: '油揚げ',       category: '大豆製品' },
  { name: '厚揚げ',       category: '大豆製品' },
  { name: '豆乳',         category: '大豆製品' },
  { name: '大豆',         category: '大豆製品' },
  ...
  { name: 'パン粉',       category: '乾物・缶詰' },
  { name: '片栗粉',       category: '乾物・缶詰' },
...
function migrateState() {
  // 「大豆製品」カテゴリ新設に伴い、旧カテゴリに登録済みの豆腐・納豆などを移動する
  const SOY_PRODUCT_NAMES = ['豆腐', '絹豆腐', '木綿豆腐', '高野豆腐', '納豆', '油揚げ', '厚揚げ', 'がんもどき', '豆乳', 'おから', '大豆'];
  // 「きのこ」カテゴリ新設に伴い、旧カテゴリ（野菜など）に登録済みのキノコ類を移動する
  const MUSHROOM_NAMES = ['しいたけ', 'しめじ', 'ぶなしめじ', 'えのき', 'エノキ', 'まいたけ', 'マイタケ', 'エリンギ', 'マッシュルーム', 'なめこ', 'きくらげ', 'ひらたけ', '干ししいたけ'];
  for (const ing of state.ingredients) {
    ...
    if (ing.category !== '大豆製品' && SOY_PRODUCT_NAMES.includes(ing.name)) {
      ing.category = '大豆製品';
    }
    if (ing.category !== 'きのこ' && MUSHROOM_NAMES.includes(ing.name)) {
      ing.category = 'きのこ';
    }
    delete ing.quantity;
    delete ing.unit;
